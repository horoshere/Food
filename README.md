...
2. Создан локальный сервер с помощью json-server - npm [example site]
[example site]:https://www.npmjs.com/package/json-server


4. Блок **Наше меню на день** созданно с помощью **Классов**. 
